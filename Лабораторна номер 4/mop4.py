...
for i in range(0,N):
    if t[i] <= Tt:
        print('t[',i,'] =',t[i],'<= Tt =',Tt,'=> b[',i,'] - не значний коефіцієнт')
        temp[i] = 0
    else:
        print('t[',i,'] =',t[i],'> Tt =',Tt,'=> b[',i,'] - значний коефіцієнт')
        temp[i] = b[i]
        d +=1
...
print('\nk=', k, '\nvuznachnyk =', vyznachnyk, '\ncommonvuznachnyk =', commonVyznachnyk, '\nresult =', result, '\ndeviration =', devariation, '\nyAverage =', yAverage, '\nb =', b, '\nsBetta =', sBetta, '\ny_2 =', y_2)
