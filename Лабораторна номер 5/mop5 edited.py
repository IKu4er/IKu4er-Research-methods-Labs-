...
matrix_with_min_max_x = np.array([[-7, 10], [-4, 6], [-5, 3]])
m = 3

time_student = perf_counter()
...
while flag_of_model is False:
    ...
    while flag_of_dispersion is False:
        ...
        if cochran_check(Y_matrix, N):
            ...
            print("Час виконання перевірки за критерієм Стьюдента -",time_student)
            print("Час виконання перевірки за критерієм Фішера -",time_phisher)
            print("Час виконання перевірки за критерієм Кохрена -",time_cochran)
